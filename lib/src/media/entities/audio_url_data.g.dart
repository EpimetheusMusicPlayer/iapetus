...
_$_AudioUrlData _$_$_AudioUrlDataFromJson(Map<String, dynamic> json) {
  return _$_AudioUrlData(
...
Map<String, dynamic> _$_$_AudioUrlDataToJson(_$_AudioUrlData instance) =>
    <String, dynamic>{
