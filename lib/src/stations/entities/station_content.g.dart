...
_$_StationContent _$_$_StationContentFromJson(Map<String, dynamic> json) {
  return _$_StationContent(
    ...
    nowPlayingStationAdUrl: Uri.parse(json['nowPlayingStationAdUrl'] as String),
...
Map<String, dynamic> _$_$_StationContentToJson(_$_StationContent instance) =>
    <String, dynamic>{
