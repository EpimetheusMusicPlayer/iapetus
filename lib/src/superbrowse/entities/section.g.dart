...
_$_SuperbrowseSection _$_$_SuperbrowseSectionFromJson(
    Map<String, dynamic> json) {
  return _$_SuperbrowseSection(
    ...
    subsections: (json['subsections'] as List<dynamic>?)
        ?.map((e) => SuperbrowseSubsection.fromJson(e as Map<String, dynamic>))
        .toList(),
  );
}

Map<String, dynamic> _$_$_SuperbrowseSectionToJson(
